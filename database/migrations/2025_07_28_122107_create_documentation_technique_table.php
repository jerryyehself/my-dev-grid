...
return new class extends Migration
{
    ...
    {
        Schema::create('documentation_technique', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['documentation_id', 'technique_id', 'relation_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('documentation_technique');
    }
};
